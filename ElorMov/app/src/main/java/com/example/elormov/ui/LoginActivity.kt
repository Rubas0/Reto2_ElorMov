            ...
            api.login(loginRequest).enqueue(object : Callback<LoginResponseDTO>{
                override fun onResponse(
                    ...
                    if (response.isSuccessful){ // codigo de respuesta [200..300]
                        ...
                        Toast.makeText(this@LoginActivity, "El usuario o la contraseña son incorrectas", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: Call<LoginResponseDTO?>, t: Throwable) {
                    Toast.makeText(this@LoginActivity, "Error de conexión con la API", Toast.LENGTH_LONG).show()
